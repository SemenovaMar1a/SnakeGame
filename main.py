...
def Your_score(score):
    ...
    record_value = score_font.render("Record: " + str(global_record), True, black)
    dis.blit(value, [0, 0])
...
def record(score):
    ...
    record_value = score_font.render("Record: " + str(global_record), True, black)
    dis.blit(record_value, [0, 35])

    if score > global_record:
        global_record = score
...
def message(msg, color):
    ...
    dis.blit(mesg, [dis_width / 7, dis_height / 3])
